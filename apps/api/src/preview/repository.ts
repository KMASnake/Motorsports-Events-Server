...
export class PostgresPreviewRepository implements PreviewRepository{
  ...
  async list(input:ListInput){
    ...
    if(input.allowedChampionshipIds)add(input.allowedChampionshipIds,n=>input.resourceType==='championship'?`s.resource_id=any($${n}::uuid[])`:`s.championship_id=any($${n}::text[])`);
