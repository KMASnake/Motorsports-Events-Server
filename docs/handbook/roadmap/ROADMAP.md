...
- Lot 5 : Fournisseurs et moteur de synchronisation API — 5.1 à 5.6 validés par le mainteneur ; design 5.7-P validé et seul gate A autorisé
...
Statut : `lot-5.7-p-a-authorized-awaiting-implementation`.
...
- 5.7-P — tranche verticale de normalisation Production Preview : **design validé mainteneur ; seul 5.7-P-A autorisé et non commencé** ;
...
**Seul 5.7-P-A est autorisé en implémentation.** Il doit s’arrêter après les
fondations persistantes et leur audit ; 5.7-P-B à F restent non autorisés. Le
Lot 5.7 complet et 5.8+ restent non autorisés. La validation du Lot 5.6
n’autorise pas sa fusion dans `main`.
