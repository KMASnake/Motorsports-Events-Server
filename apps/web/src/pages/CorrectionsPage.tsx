...
const providerLabels:Record<string,string>={
  ocblacktop:'OC BlackTop',thesportsdb:'TheSportsDB','synthetic-fixture':'Données synthétiques',
  'validation-fixture':'Validation locale','playwright-fixture':'Test d’interface'
};
