...
`authorized_sub_lot = 5.7-P` autorise la tranche verticale de normalisation Production Preview depuis le 2026-08-21. Sa conception technique, son Acceptance PP-T01 à PP-T42 et ses six gates A→F sont validés par le mainteneur. 5.7-P-A et 5.7-P-B sont validés mainteneur depuis le 2026-08-22. 5.7-P-C est implémenté et attend l’audit mainteneur ; aucun gate suivant n’est autorisé. L’état public C est une projection durable interne : promotion, révision et journal sont atomiques, le last-known-good n’est pas remplacé par un candidat non fiable, les tombstones sont permanents et aucune route client n’est exposée. Voir ADR-0021. Le **Lot 5.7 complet et les Lots 5.8+ restent non autorisés**.
