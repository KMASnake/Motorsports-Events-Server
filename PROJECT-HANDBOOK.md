...
`authorized_sub_lot = 5.7-P` autorise la tranche verticale de normalisation Production Preview depuis le 2026-08-21. Sa conception technique, son Acceptance PP-T01 à PP-T42 et ses six gates A→F sont validés par le mainteneur. 5.7-P-A est validé mainteneur le 2026-08-22. Seul `authorized_technical_sub_lot = 5.7-P-B` est ouvert et reste non commencé ; il couvre la production déterministe de candidats normalisés depuis la source 5.6, sans publication ni exposition client. La validation de A et l’autorisation de B ne valent pas autorisation de fusion dans `main`. Le **Lot 5.7 complet et les Lots 5.8+ restent non autorisés**.
