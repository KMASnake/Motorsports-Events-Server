...
`authorized_sub_lot = 5.7-P` autorise la tranche verticale de normalisation Production Preview depuis le 2026-08-21. Sa conception technique, son Acceptance PP-T01 à PP-T42 et ses six gates A→F sont validés par le mainteneur. 5.7-P-A et 5.7-P-B sont validés mainteneur depuis le 2026-08-22. La correction additive d'historique public de 5.7-P-C est terminée et attend une revalidation mainteneur. 5.7-P-D est implémenté et attend l’audit mainteneur ; sa validation n’est pas revendiquée et 5.7-P-E reste non autorisé. L’état public C associe état courant, versions canoniques immuables, révision et journal dans une transaction ; le last-known-good n’est pas remplacé par un candidat non fiable et les tombstones sont permanents. Les routes D définitives restent désenregistrées du serveur de production avant E. La préproduction reste interne, lie PostgreSQL/API/Web à loopback et exige backup, secrets hors Git et validation réelle. Voir ADR-0021. Le **Lot 5.7 complet et les Lots 5.8+ restent non autorisés**.
