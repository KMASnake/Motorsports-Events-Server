...
const created=await call('/api/v1/admin/events',{method:'POST',body:JSON.stringify({championship_id:championships[0].id,circuit_id:circuits[0]?.id??null,name:`Événement de validation Lot 4 ${marker}`,category:null,starts_at:'2026-12-20T10:00:00.000Z',ends_at:'2026-12-20T12:00:00.000Z',status:'scheduled',published:true,description:'Événement de validation public.'})});console.log('Création OK :',created.id);
