...
const mappingRepository=new PostgresNormalizationMappingRepository();
const oneShotRunner=new BoundedProviderOneShotRunner(providerService,undefined,undefined,undefined,mappingRepository,quotaService);
await app.register(providerRoutes,{service:providerService,quota:quotaService,sources:new ProviderSourcesAdminService(providerService,mappingRepository,oneShotRunner)});
