...
`authorized_sub_lot = 5.7-P` autorise la tranche verticale de normalisation Production Preview depuis le 2026-08-21. Sa conception technique, son Acceptance PP-T01 à PP-T42 et ses six gates A→F sont validés par le mainteneur. 5.7-P-A est validé mainteneur. 5.7-P-B, limité à la production déterministe de candidats/décisions/checkpoints depuis la source 5.6 sans publication ni exposition client, est complet depuis le 2026-08-22 et attend l’audit mainteneur. `authorized_technical_sub_lot = null` et aucun gate suivant n’est ouvert. Le **Lot 5.7 complet et les Lots 5.8+ restent non autorisés**, comme la fusion dans `main`.
