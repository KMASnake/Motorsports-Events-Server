...
`authorized_sub_lot = 5.7-P` autorise la tranche verticale de normalisation Production Preview depuis le 2026-08-21. Sa conception technique, son Acceptance PP-T01 à PP-T42 et ses six gates A→F sont validés par le mainteneur. 5.7-P-A et 5.7-P-B sont validés mainteneur depuis le 2026-08-22. Seul `authorized_technical_sub_lot = 5.7-P-C` est ouvert et reste non commencé ; il couvre l’état publiable durable interne, le last-known-good, les révisions et le journal monotone, sans route ni exposition client. La validation de B et l’autorisation de C ne valent pas autorisation de fusion dans `main`. Le **Lot 5.7 complet et les Lots 5.8+ restent non autorisés**.
